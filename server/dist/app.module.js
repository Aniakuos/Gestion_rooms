...
const dm_module_1 = require("./room/dm/dm.module");
const dm_service_1 = require("./room/dm/dm.service");
let AppModule = class AppModule {
};
AppModule = __decorate([
    (0, common_1.Module)({
        imports: [room_module_1.RoomModule, prisma_module_1.PrismaModule, user_module_1.UserModule, dm_module_1.DmModule],
